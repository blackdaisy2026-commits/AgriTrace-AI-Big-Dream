            ...
            <main className="pt-24 pb-20 px-4">
                <div className="max-w-4xl mx-auto">
                    <motion.div
                        ...
                        className="mb-12"
                    >
                        <h1 className="text-4xl font-black text-slate-900 mb-4 font-outfit">
                            Developer <span className="gradient-text">Docs</span>
                        </h1>
                        <p className="text-slate-500">Technical specifications and design patterns of the AgriTraceIndia platform.</p>
                    </motion.div>
                    ...
                    <div className="space-y-8">
                        {sections.map((sec, i) => (
                            <motion.section
                                ...
                                className="glass-card p-8 border-slate-200"
                            >
                                <div className="flex items-center gap-3 mb-4 text-green-400">
                                    {sec.icon}
                                    <h2 className="text-xl font-bold text-slate-900 font-outfit">{sec.title}</h2>
                                </div>
                        ...
                        >
                            ...
                            <h3 className="text-slate-900 font-bold mb-2">Open Source</h3>
                            <p className="text-slate-500 text-sm mb-6">
                                This project is built for transparency. The full source code and smart contracts are available for audit.
                            </p>
                            <div className="flex justify-center gap-4">
                                <button className="px-6 py-2 rounded-full bg-slate-100 text-slate-900 text-xs font-bold hover:bg-white/20 transition-all">
                                    GitHub Repository
                                </button>
