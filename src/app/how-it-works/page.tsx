...
const steps = [
    {
        ...
        title: "விவசாயியாக கணக்கு பதிவு செய்யவும்",
        shortTitle: "விதிமுறைகள் / பதிவு",
        color: "text-green-400",
        bg: "bg-green-500/10",
        border: "border-green-500/30",
        glow: "shadow-green-500/10",
        details: [
            "இப்போதே கணக்கு உருவாக்க AgriTraceIndia பக்கத்திற்கு செல்லவும்.",
            "விவசாயி என்ற வகை தேர்ந்தெடுக்கப்பட்டுள்ளதா என்பதை உறுதிசெய்யவும்.",
            "விவசாயி பெயர் மற்றும் அலைபேசி எண்ணை உள்ளீடு செய்யவும்.",
            "விபரங்களை சரிபார்த்து உறுதி செய்யவும் — விவசாயி (Farmer) கணக்கு தயாராகிவிடும்.",
        ],
        tip: "💡 உதவிக்குறிப்பு: உங்களது சரியான மொபைல் எண்ணை உள்ளிடவும். எதிர்கால தேவைகளுக்கு பயனுள்ளதாக இருக்கும்.",
        cta: { label: "இப்போதே பதிவு செய்க", href: "/login" },
    },
    {
        step: "படி 2",
        icon: <FileText className="w-8 h-8" />,
        title: "விவரங்களை பதிவு செய்யவும்",
